<template>
	<div class="userInfoDetail">
		<div class="Info">
			<ul>
				<li v-for="(item,key) in currentInfo" :key="key">
					<div class="info-list">
						...
						<div v-else>
							<mu-text-field full-width disabled v-model="item.edit" :prefix="item.title" :suffix="item.value">
							</mu-text-field>
						</div>
					</div>
				</li>
			...
			getNowInfo() {
				getCurrentUserInfo().then(res => {
					this.currentInfo = {
						...
						province: { title: '省份', value: res.data.profile.province, edit: '' },
						city: { title: '城市', value: res.data.profile.city, edit: '' },
